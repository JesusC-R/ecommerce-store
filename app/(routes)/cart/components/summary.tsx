...
const Summary = () => {
  ...
  const items = useCart((state) => state.items); // Retrive items
  const removeAll = useCart((state) => state.removeAll); // Retrive function
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-items justify-between border-t border-gray-200 pt-4">
